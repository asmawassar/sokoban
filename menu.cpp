...
menu::menu(RenderWindow *window, Font *font)
{
    ...
    this->choose_char= new button ( 225,300,350,100,40,font,"Choose Player",Color(245,166,179));
    this->manual= new button ( 225,450,350,100,40,font,"Manual",Color(243,172,166));
     this->about= new button ( 225,600,350,100,40,font,"About Creators",Color(242,197,199));
}
